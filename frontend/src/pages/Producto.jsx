...
const Producto = () => {
  ...
  // Estados del probador 3D
  const [isTryOnOpen, setIsTryOnOpen] = useState(false);
  const [altura, setAltura] = useState(175);
  const [peso, setPeso] = useState(75);

  // Mapeo dinámico de modelos 3D según el ID del producto
  const mapeoModelos = {
    1: "Avatar_Pvreza.glb",
    2: "Avatar_Pvreza.glb",
    3: "Avatar_Pvreza.glb",
  };
  const modeloAMostrar = mapeoModelos[id] || "camiseta_azul.glb";
    ...
    <main>
      ...
      <section style={styles.product}>
        ...
        <div style={styles.carouselWrapper}>
          ...
          {imagenes.length > 1 && (
            <>
              <button onClick={anterior} style={{ ...styles.arrow, left: "12px" }}>
                &#10094;
              </button>
              <button onClick={siguiente} style={{ ...styles.arrow, right: "12px" }}>
                &#10095;
              </button>
            </>
          )}
      ...
      {isTryOnOpen && (
        <div style={styles.modalOverlay}>
          <div style={styles.modalContent}>
            <button onClick={() => setIsTryOnOpen(false)} style={styles.modalClose}>
              &times;
            </button>
            <div style={styles.modalLayout}>
              ...
              <div style={styles.modalCanvas}>
                <AvatarCreator
                  ...
                  peso={Number(peso)}
                  modeloCamiseta={modeloAMostrar} // 💥 Modelo inyectado dinámicamente
                />
              </div>
              ...
              <div style={styles.modalControls}>
                ...
                <div style={styles.infoBox}>
                  <p style={{ margin: 0 }}>
                    <strong>Talla recomendada:</strong> {altura > 180 || peso > 85 ? "XL" : "L"}
                  </p>
                </div>
